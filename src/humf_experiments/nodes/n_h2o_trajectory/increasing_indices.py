...
parser.add_argument('--M_molecules', type=int, help='an integer for the number of molecules')
parser.add_argument('--N_concat', type=int, help='an integer for the number of concatenations')
